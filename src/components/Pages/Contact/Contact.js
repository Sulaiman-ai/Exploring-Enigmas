...
function Contact() {
    ...
    return (
            <>
                ...
                <h2 className="contact-h2">Get in touch with our friendly team. Send us a postcard, or maybe just fill out the form below!</h2>
                ...
                {success && <p className="success-message">Form submitted. Thank you for your message. We'll get back to you as soon as we can.</p>}
            </>
        )
    }
